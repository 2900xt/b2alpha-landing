  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-10 flex flex-col">
        ...
        <main className="flex-1 overflow-y-auto flex items-center px-4 sm:px-6 py-8 sm:py-12">
          <div className="max-w-5xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <InteractiveWindow
              ...
              details="Add structured metadata — capabilities, pricing, location, API endpoints. User agents find you automatically through search. Accept direct API calls for simple tasks, or use B2Alpha's hosted conversation platform for negotiations, escrow, and audit trails."
